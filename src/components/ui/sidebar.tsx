// Purpose: App sidebar layout and navigation primitives.
"use client";
...
// Purpose:
// Provides sidebar open/collapsed state, mobile sheet, cookie persistence, and keyboard shortcut.
// Runs when SidebarProvider wraps the app sidebar layout.
// Expected result: SidebarContext for child sidebar components (Ctrl/Cmd+B toggles).
