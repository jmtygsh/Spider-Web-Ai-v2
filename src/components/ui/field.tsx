...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "-my-2 h-2 mb-2 mt-2 text-sm group-data-[variant=outline]/field-group:-mb-2 relative",
        className
      )}
      {...props}
    >
...
// Purpose:
// Renders field validation errors — dedupes messages and supports single or list display.
// Runs when a FieldError is rendered with errors from react-hook-form.
// Expected result: inline error text or bullet list of unique messages.
function FieldError({
  className,
  children,
  errors,
  ...
  // Deduplicate validation messages and render a single line or bullet list.
